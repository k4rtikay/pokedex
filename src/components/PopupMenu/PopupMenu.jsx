    ...
    <div className="menu-container" ref={dropdownRef}>
      ...
      >
        <div className="about-modal-content">
          <h2>About HueDex</h2>
          <p>
            HueDex is a color palette generator inspired by the world of
            Pokémon. It's a personal project built with React, Framer Motion,
            and Firebase to explore design, animation, and web development.
          </p>

          <p>
            You can explore by selecting a Pokémon from the list to see its
            color palette and press Spacebar on desktop or use the 'Generate'
            button to discover new ones on mobile. Don't forget to save your
            favorites to your personal library! All Pokémon data and sprites are
            gratefully provided by the{" "}
            <a
      ...
      <AnimatePresence>
        ...
        >
          <span className="h-icon material-symbols-rounded">
            account_circle
          </span>
        </button>
        {isMenuActive && (
          ...
          >
            ...
            <nav className="menu-nav">
              ...
              <motion.a
                variants={navItemVariants}
                href="https://github.com/k4rtikay/pokedex/issues"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ opacity: 1 }}
              >
              ...
              >
                {globalUser ? "Sign Out" : "Sign In"}
              </motion.button>
            </nav>

            <motion.footer variants={navItemVariants}>
              Made with ❤️ by{" "}
              <a
                href="https://github.com/k4rtikay"
                target="_blank"
                rel="noopener noreferrer"
              >
                k4rtikay
